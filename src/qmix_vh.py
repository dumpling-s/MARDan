...
class QMIX:
    ...
    def get_q_values(self, batch,model):
        ...
        with torch.no_grad():
            lm_logits_e, loss_e, value_e = model_WithValueHead.forward(input_ids=inputs[0],
                                                  attention_mask=attention_mask,
                                                  )
            lm_logits_t, loss_t, value_t = model_WithValueHead.forward(input_ids=inputs_a[0],
                                                  attention_mask=attention_mask,
                                                  )
